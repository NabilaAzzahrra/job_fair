    ...
    return (
        <div>
            ...
            <section className='px-6 py-4'>
                <div className='flex justify-between items-end'>
                    <div className='space-y-2'>
                        <h1 className='text-3xl font-bold text-slate-700'>PROBLEM ACCOUNT OFFICER & REMEDIAL OFFICER ALL</h1>
                    </div>
                </div>
                ...
                <p className='px-1'>
                    <ul class="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-400">
                        ...
                        <li className='flex items-center space-x-3 rtl:space-x-reverse'>
                            ...
                            Memiliki Kendaraan Roda 2 dan Sim
                        </li>
                        <li className='flex items-center space-x-3 rtl:space-x-reverse'>
                            <svg class="w-3.5 h-3.5 me-2 text-green-500 dark:text-green-400 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z" />
                ...
                <p className='py-4 text-2xl text-slate-700 font-bold'>Job Desk :</p>
                <p className='px-1'>
                ...
                <p className='py-4 text-2xl text-slate-700 font-bold'>Kebutuhan :</p>
                <p className='text-1xl'>
                    6 Orang Tasikmalaya, 6 Garut,3 Banjar Wilayah penempatan domili Ciamis, Banjar, Pangandaran, Tasikmalaya, Singaparna, Karangnunggal, Garut, Limbangan , Cikajang
                </p>

                <a href='https://forms.gle/dWLXsjSTTJw4yTUs7' className='mt-3 flex'>
            ...
            <section className='px-6 py-4'>
                <div className='flex justify-between items-end'>
                    <div className='space-y-2'>
                        <h1 className='text-3xl font-bold text-slate-700'>SALES OFFICER MOBILE</h1>
                    </div>
                </div>
                <p className='py-4 text-2xl text-slate-700 font-bold'>Kriteria Kandidat :</p>
                <p className='px-1'>
            ...
            <section className='px-6 py-4'>
                <div className='flex justify-between items-end'>
                    <div className='space-y-2'>
                        <h1 className='text-3xl font-bold text-slate-700'>DATA ADMIN STAFF</h1>
                    </div>
                </div>
                <p className='py-4 text-2xl text-slate-700 font-bold'>Kriteria Kandidat :</p>
                <p className='px-1'>
                    <ul class="max-w-md space-y-1 text-gray-500 list-inside dark:text-gray-400">
                        ...
                        <li className='flex items-center space-x-3 rtl:space-x-reverse'>
                            ...
                            Menyukai pekerjaan Adminstrasi
                        </li>
                        <li className='flex items-center space-x-3 rtl:space-x-reverse'>
                            <svg class="w-3.5 h-3.5 me-2 text-green-500 dark:text-green-400 flex-shrink-0" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                                <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5Zm3.707 8.207-4 4a1 1 0 0 1-1.414 0l-2-2a1 1 0 0 1 1.414-1.414L9 10.586l3.293-3.293a1 1 0 0 1 1.414 1.414Z" />
                ...
                <p className='px-1'>
                    <ul className='space-y-4 text-left text-gray-500 dark:text-gray-400'>
                        <li className='flex items-center space-x-3 rtl:space-x-reverse'>
                            ...
                            <span>Distribusi map PK</span>
                        </li>
                        <li className='flex items-center space-x-3 rtl:space-x-reverse'>
                            <svg class="flex-shrink-0 w-3.5 h-3.5 text-green-500 dark:text-green-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5.917 5.724 10.5 15 1.5" />
                            </svg>
                            <span>Handling dokumen / map PK</span>
                        </li>
                        <li className='flex items-center space-x-3 rtl:space-x-reverse'>
                            <svg class="flex-shrink-0 w-3.5 h-3.5 text-green-500 dark:text-green-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5.917 5.724 10.5 15 1.5" />
                            </svg>
                            <span>Full data entry</span>
                        </li>
                        <li className='flex items-center space-x-3 rtl:space-x-reverse'>
                            <svg class="flex-shrink-0 w-3.5 h-3.5 text-green-500 dark:text-green-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5.917 5.724 10.5 15 1.5" />
                            </svg>
                            <span>Maintenance gudang PK</span>
                        </li>
                        <li className='flex items-center space-x-3 rtl:space-x-reverse'>
                            <svg class="flex-shrink-0 w-3.5 h-3.5 text-green-500 dark:text-green-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5.917 5.724 10.5 15 1.5" />
                            </svg>
                            <span>Pengurusan fidusia</span>
                        </li>
                        <li className='flex items-center space-x-3 rtl:space-x-reverse'>
                            <svg class="flex-shrink-0 w-3.5 h-3.5 text-green-500 dark:text-green-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5.917 5.724 10.5 15 1.5" />
                            </svg>
                            <span>Penerimaan tagihan dari dealer</span>
                        </li>
                        <li className='flex items-center space-x-3 rtl:space-x-reverse'>
                            <svg class="flex-shrink-0 w-3.5 h-3.5 text-green-500 dark:text-green-400" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M1 5.917 5.724 10.5 15 1.5" />
                            </svg>
                            <span>Filing map PK dan peminjaman map PK</span>
                        </li>
                    </ul>
                </p>
                <p className='py-4 text-2xl text-slate-700 font-bold'>Kebutuhan :</p>
